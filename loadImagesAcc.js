...
const imagesDirectory = './static/accPortraitH3/Top'; // Chemin vers le dossier des images

// Supprimer le contenu existant du fichier imagesList.js
fs.writeFileSync('./public/imagesListAcc.js', '', 'utf-8');
...
fs.readdir(imagesDirectory, (err, files) => {
  ...
  fs.appendFileSync('./public/imagesListAcc.js', `export const images = ${imagesList};`, 'utf-8');
});
